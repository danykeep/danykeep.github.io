...
Чем отличаются Повестка и Протокол
...
В документах, договорах и совещаниях есть возможность отмечать вложение как основное. Эта возможность доступна только при создании карточки или когда карточка находится у каких-либо сотрудников на доработке. Отметку также может выставлять администратор системы.
