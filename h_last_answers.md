...
Также, при утверждении можно подписать поля утверждаемой карточки, эти поля становятся недоступны для редактирования после подписания.

**Где хранится ЭП?**
Файл сертификата подписи хранится на локальном диске.

**Где хранится в подписи?**
Подпись хранится на стороне сервера, на котором функционирует ТЕЗИС.
