...
Для входящего документа проверка осуществляется по Отправителю, номеру исходящего документа и датой исходящего документа.

Для внутреннего документа по регистрационному номеру.
