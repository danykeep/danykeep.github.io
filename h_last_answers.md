...
Электронной подписью в ТЕЗИС можно подписывать вложения документов и договоров. Это можно делать при утверждении и согласовании. Кроме того, при утверждении можно подписывать поля утверждаемой карточки, эти поля становятся недоступны для редактирования после подписания.

**Где хранится ЭП?**
Файл сертификата подписи хранится на локальном диске.

**Где хранится в подписи?**
Подпись хранится на стороне сервера, на котором функционирует ТЕЗИС. То есть внутри системы, а не внутри документа. Если скачать вложенный файл, он будет без подписи.
