...
**Что подписывается?**
Электронной подписью в ТЕЗИС можно подписать документ или договор в следующих процессах:
- Согласование
- Утверждение

В карточках документов и договоров во вкладке «Вложения» появляется кнопка "Проверить подписи" и колонка "Подписи".
