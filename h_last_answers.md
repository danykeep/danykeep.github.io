...
Электронной подписью в ТЕЗИС можно подписывать вложения документов и договоров. Это можно делать при утверждении и согласовании. Также, при утверждении можно подписывать поля утверждаемой карточки, эти поля становятся недоступны для редактирования после подписания.

**Где хранится ЭП?**
Файл сертификата подписи хранится локально на компьютере пользователя.

**Где хранится в подписи?**
Подпись хранится непосредственно в рамках системы ТЕЗИС. Если скачать вложенный файл, он будет без подписи.
