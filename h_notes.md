...
- Мой отдел находится отдельно, а не в категории Канцелярии стр. 16
- В процессе согласования, на диаграмме Начало указано неверно.
- User_manual, стр.53, ошибка в тексте на скриншоте
- Механизм предотвращения повторной регистрации документов описан неверно (про автоматическую нумерацию), стр. 134-135
- Стр. 73, "админстратором"

Пароль сертификата: 12haulmont

Вопросы:  
Отображается ли код подразделения в меню выбора пользователя.
Роль по умолчанию.
История переписки.
...
По этой прицине Автор и Инициатор задачи могут быть не одним человеком. Автор - это тот, кто создает задачу, Инициатор - тот, кто отправляет ее Исполнителю.
